...
namespace IgrejaV2.Infraestrutura.Migrations
{
    ...
    [Migration("20260604181908_AddPrincipalToPessoaEndereco")]
    partial class AddPrincipalToPessoaEndereco
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IgrejaV2.Dominio.Entidades.Familia", b =>
                {
                    ...
                    b.HasIndex("Nome")
                        .IsUnique()
                        .HasDatabaseName("idx_nome_familia_unique");
            ...
            modelBuilder.Entity("IgrejaV2.Dominio.Entidades.Versiculo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
